...
//======================================Shiny Background
export const EyeCatchingButton_v2 = ({ className, ...props }: ButtonProps) => {
  return (
    <Button
      {...props}
      className={cn(
        "animate-bg-shine disabled:animate-none border-[1px] rounded-lg shadow bg-[length:200%_100%] tracking-wide duration-[2200ms]",
